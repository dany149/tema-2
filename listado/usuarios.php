    ...
    <table>
        ...
        <?php foreach ($usuarios as $usuario) : ?>
            <tr>
                ...
                <td><img src="<?php echo $usuario['imagen']; ?>" alt="Imagen de perfil" style="max-width: 50px;"></td>
                <td>
                    ...
                    | <a href='operaciones/detalle_usuario.php?id=<?php echo $usuario['id']; ?>'>Detalle</a>
                </td>
            </tr>
        <?php endforeach; ?>
    </table>
